    ...
    <main className="mx-auto max-w-2xl space-y-6">
      <section className="rounded-[34px] bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          QR-код валиден. Можно выдать гостю обещанный бонус.
        </p>
      </section>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-[28px] bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 text-xl font-black">Алекс</div>
          <div className="text-sm text-slate-500">Участник челленджа</div>
        </div>
        <div className="rounded-[28px] bg-white p-5 shadow-sm">
          <Gift className="h-6 w-6 text-emerald-600" />
          <div className="mt-4 text-xl font-black">Авторский раф</div>
          <div className="text-sm text-slate-500">Награда Coffee Place</div>
        </div>
      </section>
